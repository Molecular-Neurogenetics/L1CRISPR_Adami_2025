...
write.table(as.data.frame(gene_dds$sizeFactor), file = "/Volumes/MyPassport/CRISPRi_L1s/results/tables/gene_sizeFactors2.tab", quote = F, sep="\t", col.names = F)
...
samplesheet_nes <- samplesheet_nes[order(samplesheet_nes$condition),]
samplesheet_nes_batch1 <- samplesheet_nes[which(samplesheet_nes$seqnum == "CTG_JGJSeq156_159_160truseq"),]
samplesheet_nes_batch2 <- samplesheet_nes[which(samplesheet_nes$seqnum == "CTG_JGJSeq233_237_250_257_2023_145"),]
...
pheatmap(log2(gene_count_norm[c(neuronal_genes, pluripotency_genes),rownames(samplesheet_nes_batch1)]+0.5), cluster_cols = F, cluster_rows = F, scale = "none", gaps_col = c(6), main = "Sai2 Batch 1", annotation_col = samplesheet[,c("LV", "cell")])
pheatmap(log2(gene_count_norm[markers$gene,rownames(samplesheet_nes_batch1)]+0.5), cluster_cols = F, cluster_rows = F, scale = "none", gaps_col = c(6), main = "Sai2 Batch 1", annotation_row = markers[,"type", drop=F], annotation_col = samplesheet[,c("LV", "cell")])
pheatmap(log2(gene_count_norm[c(neuronal_genes, pluripotency_genes),rownames(samplesheet_nes_batch2)]+0.5), cluster_cols = F, cluster_rows = F, scale = "none", gaps_col = c(3), main = "Sai2 Batch 2", annotation_col = samplesheet[,c("LV", "cell")])
pheatmap(log2(gene_count_norm[markers$gene,rownames(samplesheet_nes_batch2)]+0.5), cluster_cols = F, cluster_rows = F, scale = "none", gaps_col = c(3), main = "Sai2 Batch 2", annotation_row = markers[,"type", drop=F], annotation_col = samplesheet[,c("LV", "cell")])
# dev.off()
...
plotPCA(gene_vst_list$hiPS6_crispri_g2) + ggtitle("hiPS6_crispri_g2") + theme_bw()
...
plotPCA(gene_vst_list$NES_crispra_g1) + ggtitle("NES_crispra_g1") + theme_bw()
plotPCA(gene_vst_list$NES_crispra_g2) + ggtitle("NES_crispra_g2") + theme_bw()
plotPCA(gene_vst_list$NES_crispra_g3) + ggtitle("NES_crispra_g3") + theme_bw()
...
plotPCA(gene_vst_list$hiPS6_org_crispri_g2) + ggtitle("hiPS6_org_crispri_g2") + theme_bw()
plotPCA(gene_vst_list$hiPS6_org_crispri_g1) + ggtitle("hiPS6_org_crispri_g1") + theme_bw()
plotPCA(gene_vst_list$hiPS6_org_crispra_g1) + ggtitle("hiPS6_org_crispra_g1") + theme_bw()
plotPCA(gene_vst_list$hiPS6_org_crispra_g2) + ggtitle("hiPS6_org_crispra_g2") + theme_bw()
plotPCA(gene_vst_list$hiPS6_org_crispra_g3) + ggtitle("hiPS6_org_crispra_g3") + theme_bw()
plotPCA(gene_vst_list$hiPS6_org_crispra_g3_batch2) + ggtitle("hiPS6_org_crispra_g3_batch2") + theme_bw()
# dev.off()
```
...
openxlsx::write.xlsx(list("hiPS6_crispri_g1" = gene_res_list_df$hiPS6_crispri_g1[which(abs(gene_res_list_df$hiPS6_crispri_g1$log2FoldChange) > 1 & gene_res_list_df$hiPS6_crispri_g1$padj < 0.05),],
"hiPS6_crispri_g2" = gene_res_list_df$hiPS6_crispri_g2[which(abs(gene_res_list_df$hiPS6_crispri_g2$log2FoldChange) > 1 & gene_res_list_df$hiPS6_crispri_g2$padj < 0.05),],
"hiPS6_crispri_g3" = gene_res_list_df$hiPS6_crispri_g3[which(abs(gene_res_list_df$hiPS6_crispri_g3$log2FoldChange) > 1 & gene_res_list_df$hiPS6_crispri_g3$padj < 0.05),],
"hiPS48_crispri_g3" = gene_res_list_df$hiPS48_crispri_g3[which(abs(gene_res_list_df$hiPS48_crispri_g3$log2FoldChange) > 1 & gene_res_list_df$hiPS48_crispri_g3$padj < 0.05),],
"hiPS6_org_crispri_g1" = gene_res_list_df$hiPS6_org_crispri_g1[which(abs(gene_res_list_df$hiPS6_org_crispri_g1$log2FoldChange) > 1 & gene_res_list_df$hiPS6_org_crispri_g1$padj < 0.05),],
"hiPS6_org_crispri_g2" = gene_res_list_df$hiPS6_org_crispri_g2[which(abs(gene_res_list_df$hiPS6_org_crispri_g2$log2FoldChange) > 1 & gene_res_list_df$hiPS6_org_crispri_g2$padj < 0.05),],
"hiPS6_org_crispri_g3" = gene_res_list_df$hiPS6_org_crispri_g3[which(abs(gene_res_list_df$hiPS6_org_crispri_g3$log2FoldChange) > 1 & gene_res_list_df$hiPS6_org_crispri_g3$padj < 0.05),],
"hiPS6_org_crispri_g3_batch2" = gene_res_list_df$hiPS6_org_crispri_g3_batch2[which(abs(gene_res_list_df$hiPS6_org_crispri_g3_batch2$log2FoldChange) > 1 & gene_res_list_df$hiPS6_org_crispri_g3_batch2$padj < 0.05),],
"hiPS48_org_crispri_g3" = gene_res_list_df$hiPS48_org_crispri_g3[which(abs(gene_res_list_df$hiPS48_org_crispri_g3$log2FoldChange) > 1 & gene_res_list_df$hiPS48_org_crispri_g3$padj < 0.05),]), file = "/Volumes/MyPassport/CRISPRi_L1s/results/tables/genes_bulkRNA_DEA_crispri.xlsx")
...
# dev.off()
# pdf("/Volumes/MyPassport/CRISPRi_L1s/results/plots/GSEA_top20_padj/hiPS6_org_crispri_g2_gsea.pdf", width = 8)
top20_gsea$hiPS6_org_crispri_g2
# dev.off()
...
# dev.off()
# pdf("/Volumes/MyPassport/CRISPRi_L1s/results/plots/GSEA_top20_padj/hiPS6_org_crispra_g1_gsea.pdf", width = 12)
top20_gsea$hiPS6_org_crispra_g1
# dev.off()
# pdf("/Volumes/MyPassport/CRISPRi_L1s/results/plots/GSEA_top20_padj/hiPS6_org_crispra_g2_gsea.pdf", width = 12)
top20_gsea$hiPS6_org_crispra_g2
# dev.off()
# pdf("/Volumes/MyPassport/CRISPRi_L1s/results/plots/GSEA_top20_padj/hiPS6_org_crispra_g3_gsea.pdf", width = 12)
top20_gsea$hiPS6_org_crispra_g3
# dev.off()
# pdf("/Volumes/MyPassport/CRISPRi_L1s/results/plots/GSEA_top20_padj/hiPS6_org_crispra_g3_batch2_gsea.pdf", width = 7)
top20_gsea$hiPS6_org_crispra_g3_batch2
# dev.off()
...
gse_list_df <- list("hiPS6_crispri_g1" = gse_list$hiPS6_crispri_g1@result,
                    "hiPS6_crispri_g2" = gse_list$hiPS6_crispri_g2@result,
                    "hiPS6_crispri_g3" = gse_list$hiPS6_crispri_g3@result,
                    # "hiPS48_g3" = gse_list$hiPS48_crispri_g3@result,
                    "NES_crispra_g1" = gse_list$NES_crispra_g1@result,
                    "NES_crispra_g2" = gse_list$NES_crispra_g2@result,
                    "NES_crispra_g3" = gse_list$NES_crispra_g3@result,
                    "hiPS6_org_crispri_g1" = gse_list$hiPS6_org_crispri_g1@result,
                    "hiPS6_org_crispri_g2" = gse_list$hiPS6_org_crispri_g2@result,
                    ...
                    # "hiPS48_crispri_g3" = gse_list$hiPS48_crispri_g3@result,
                    "hiPS6_org_crispra_g1" = gse_list$hiPS6_org_crispra_g1@result,
                    "hiPS6_org_crispra_g2" = gse_list$hiPS6_org_crispra_g2@result,
                    "hiPS6_org_crispra_g3" = gse_list$hiPS6_org_crispra_g3@result,
                    "hiPS6_org_crispra_g3_batch2" = gse_list$hiPS6_org_crispra_g3_batch2@result
                    )
...
# openxlsx::write.xlsx(gse_list_df, "/Volumes/MyPassport/CRISPRi_L1s/results/tables/genes_GSEA.xlsx")
